package Gourmet::Importer::MealMaster::Formalize;
...
';
  ...
  if ($inglist) {
	...
	$item->set_text($self->Formalize("You need ".$c));
  ...
  foreach my $parag (@para) {
    ...
    foreach my $sentence (@{$sentences}) {
      ...
      $step->set_text($self->Formalize("You should ".$sentence));
